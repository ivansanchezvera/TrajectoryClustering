...
public final class ProjMath {
     ...
     * Normalizes latitude if at or exceeds epsilon distance from a pole.
     ...
     * projection, usually the lower right corner of the area of
     * interest.
     * @param projection the projection to use for other projection
     * parameters, like map width and map height.
     */
	...
	LatLonPoint ll1 = projection.inverse(point1);
	LatLonPoint ll2 = projection.inverse(point2);
